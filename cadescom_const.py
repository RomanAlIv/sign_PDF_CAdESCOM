...
CADESCOM_MEMORY_STORE = 0    #Хранилище сертификатов в памяти компьютера. Аналогично CAPICOM_MEMORY_STORE. Изменения, сделанные в данном хранилище, не сохраняются.
...
CARRIER_FLAG_ABLE_SET_KEY = 32    #Признак возможности установки закрытого ключа на ФКН-носитель.
